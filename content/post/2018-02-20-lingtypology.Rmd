---
title: "Interactive language maps in R with lingtypology"
summary: "If you're a linguist or interested in the languages of the world, the lingtypology package is for you"
...
Some languages appear to be missing geographical coordinates, which the user can then supply, or change cureent coordinates.
In the following map, we will also add these features: 
<br>
1. zoom control <br>
2. zoom level <br>
3. a minimap <br>
...
There are several map types available. have a look here: 
...
Mapping two language families gets slightly more tricky and requires a bit of coding. Here we'll map Bantu and Khoisan languages. <br>
